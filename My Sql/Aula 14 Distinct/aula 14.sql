create table venda(
 i_venda_venda  int primary key not null,
...
alter table venda add constraint fk_i_cliente_cliente foreign key (i_cliente_cliente) references cliente (i_cliente_cliente);
